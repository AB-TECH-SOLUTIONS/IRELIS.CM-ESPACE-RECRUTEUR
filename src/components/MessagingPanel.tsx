...
export function MessagingPanel() {
  ...
  const handleSendMessage = () => {
    if (messageText.trim()) {
      ...
      // Logic to send message with disclaimer
      console.log("Message envoyé avec disclaimer:", messageWithDisclaimer);
      setMessageText("");
    }
  };

  const handleUseTemplate = (template: MessageTemplate) => {
    // Le disclaimer sera automatiquement ajouté lors de l'envoi
        ...
        <Card className="lg:col-span-2">
          {selectedConv ? (
            <CardContent className="p-0 flex flex-col h-full">
              {/* Header - Nom et poste du candidat */}
              <div className="p-4 border-b">
                ...
                {/* Onglets Messages types et Planifier entretien */}
