...
const applicationsData = [
  ...
  { month: "Août 2024", candidatures: 38, entretiens: 10, offres: 2, embauches: 1, vues: 1456 },
  { month: "Sept 2024", candidatures: 67, entretiens: 18, offres: 6, embauches: 5, vues: 2134 },
  { month: "Oct 2024", candidatures: 78, entretiens: 22, offres: 7, embauches: 6, vues: 2456 },
...
export function AnalyticsDashboard() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      // Fonction pour ajouter watermark et footer sur chaque page
      const addWatermarkAndFooter = (pageNum: number, totalPages: number) => {
        // Watermark diagonal au centre
      ...
      pdf.setFontSize(14);
      pdf.text("Tableau de bord recrutement", pageWidth / 2, 42, {
        align: "center",
      });
      ...
      for (let i = 1; i < tableData.length; i++) {
        if (i % 2 === 0) {
          ...
          pdf.rect(20, yPos, colWidths.reduce((a, b) => a + b, 0), 7, "F");
        }
      ...
      pdf.text("💡 Insights Clés", 20, yPos);
